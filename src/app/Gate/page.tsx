    ...
    <div className="font-sans">
      ...
      <section className="py-12 px-6 md:px-12 lg:px-24 bg-gray-100">
        ...
        <div className="space-y-4">
          ...
          >
            <span className="font-semibold">Gate Valve :</span> Flanged End
          </Link>
          ...
          <Link
            ...
            className="flex items-center hover:text-orange-600 transition-colors"
          >
            <span className="font-semibold">Gate Valve :</span>Screw End
          </Link>
          ...
          <Link
            ...
            className="flex items-center hover:text-orange-600 transition-colors"
          >
            <span className="font-semibold">Gate Valve :</span>Socket Weld
          </Link>
        </div>
      </section>
      ...
      <section className="py-12 px-6 md:px-12 lg:px-24 bg-gray-100">
        ...
        <div>
          <p className="font-semibold text-orange-600">• Gate Valves -</p>
          <p className="ml-4">
            <u>Flanged</u>: Provides a secure connection and is suitable for
            high-pressure applications
          </p>
          <br></br>
          <p className="ml-4">
            <u>Screw</u>: Offers easy installation and is commonly used in
            smaller piping systems
          </p>
          <br></br>

          <p className="ml-4">
            <u>Socket Weld</u>: Ensures a strong, leak-proof connection and is
