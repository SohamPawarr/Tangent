    ...
    <div className="font-sans">
      ...
      <section className="py-12 px-6 md:px-12 lg:px-24 bg-white">
        <h2 className="text-2xl font-bold mb-6 text-orange-800">
          Model K73: GATE VALVE, Socket weld (800#)
        </h2>
        <div className="flex justify-center">
          <div className="flex items-center">
            <img
              src="\Gate valve\socket\k-73.png"
        ...
        <table className="border-collapse border border-gray-200">
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-gray-300 px-4 py-2">Threaded End</td>
              <td className="border border-gray-300 px-4 py-2">
                As per API 598 / ISO 5208
              </td>
              <td className="border border-gray-300 px-4 py-2">
                15 mm to 80 mm (1/2" to 3")
              </td>
            </tr>
          </tbody>
        </table>
