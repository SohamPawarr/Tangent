    ...
    <div className="font-sans">
      ...
      <section className="py-12 px-6 md:px-12 lg:px-24 bg-gray-100">
        ...
        <div className="space-y-4">
          ...
          >
            <span className="font-semibold">Globe Valve :</span> Flanged End
          </Link>
          ...
          <Link
            ...
            className="flex items-center hover:text-orange-600 transition-colors"
          >
            <span className="font-semibold">Globe Valve :</span>Screw End
          </Link>
        </div>
      </section>
      ...
      <section className="py-12 px-6 md:px-12 lg:px-24 bg-gray-100">
        ...
        <div className="space-y-4">
          <div>
            <p className="font-semibold text-orange-600">• Globe Valves -</p>
            <p className="ml-4">
              <u>Flanged</u>: Provides excellent flow control and is suitable
              for frequent operation in high-pressure systems
            </p>
            <br></br>
            <p className="ml-4">
              <u>Screw</u>: Offers precise regulation of flow and is commonly
              used in smaller pipelines and general-purpose applications
            </p>
            <br></br>
          </div>
        </div>
