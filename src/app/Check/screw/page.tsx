    ...
    <div className="font-sans">
      ...
      <section className="py-12 px-6 md:px-12 lg:px-24 bg-white">
        <h2 className="text-2xl font-bold mb-6 text-orange-800">
          Model K42: CHECK VALVE / NON RETURN VALVE, Screw End (PN16)
        </h2>
        <div className="flex justify-center">
          <div className="ml-4 flex">
            <img
              src="\Check valve\screw\k-42.png"
          ...
          <table className="w-full border-collapse text-sm">
            ...
            <tbody>
              <tr className="bg-orange-100">
                ...
                <td className="border p-2">9.53</td>
              </tr>
              <tr>
              ...
              <tr className="bg-orange-100">
                ...
                <td className="border p-2">31.75</td>
              </tr>
              <tr>
              ...
              <tr className="bg-orange-100">
                ...
                <td className="border p-2">50.8</td>
              </tr>
              <tr>
                <td className="border p-2">65</td>
                <td className="border p-2">160</td>
                <td className="border p-2">63.5</td>
              </tr>
              <tr className="bg-orange-100">
                <td className="border p-2">80</td>
                <td className="border p-2">185</td>
                <td className="border p-2">76.2</td>
              </tr>
            </tbody>
          </table>
        </div>
