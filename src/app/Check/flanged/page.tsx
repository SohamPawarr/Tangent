    ...
    <div className="font-sans">
      ...
      <section className="py-12 px-6 md:px-12 lg:px-24 bg-white">
        <h2 className="text-2xl font-bold mb-6 text-orange-800">
          Check / Non Return Valve, Flanged End (PN10, PN16)
        </h2>
        <div className="flex justify-center">
          <div className="ml-4 flex">
            <img
              src="\Check valve\flanged\k-41.png"
        ...
        <div className="overflow-x-auto mb-4">
          <table className="w-full border-collapse text-sm">
            ...
            <tbody>
              ...
              <tr>
                <td className="border p-2">150</td>
                <td className="border p-2">285</td>
              ...
              <tr>
                <td className="border p-2">250</td>
                <td className="border p-2">395</td>
        ...
        <div className="overflow-x-auto mb-4">
          <table className="w-full border-collapse text-sm">
            ...
            <tbody>
              ...
              <tr className="bg-orange-100">
                <td className="border p-2">300</td>
                <td className="border p-2">460</td>
                <td className="border p-2">700</td>
                <td className="border p-2">300</td>
              </tr>
            </tbody>
