    ...
    <div className="font-sans">
      ...
      <section className="py-12 px-6 md:px-12 lg:px-24 bg-gray-100">
        ...
        <div className="space-y-4">
          <Link
            href="butterfly/centric"
            className="flex items-center hover:text-orange-600 transition-colors"
          >
            <span className="font-semibold">Butterfly Valve :</span> Centric &
            Bi-Directional Design, Wafer & Lug
          </Link>

          <Link
            href="butterfly/eccentric"
            className="flex items-center hover:text-orange-600 transition-colors"
          >
            <span className="font-semibold">Butterfly Valve :</span> Large Size
            Double Flanged, Eccentric Design
          </Link>

          <Link
            href="butterfly/double"
            className="flex items-center hover:text-orange-600 transition-colors"
          >
            <span className="font-semibold">Butterfly Valve :</span> High
            Performance Double Offset
            <br />
          ...
          <Link
            ...
            className="flex items-center hover:text-orange-600 transition-colors"
          >
            <span className="font-semibold">Butterfly Valve :</span> PFA/PTFE
            Lined, Centric Bi-directional
          </Link>
          ...
          <Link
            ...
            className="flex items-center hover:text-orange-600 transition-colors"
          >
            <span className="font-semibold">Butterfly Valve :</span> EPDM & EPDM
            + PTFE seated Centric design
          </Link>
        </div>
      </section>
      ...
      <section className="py-12 px-6 md:px-12 lg:px-24 bg-gray-100">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="ml-4">
              <u>Wafer</u>: Suitable for water, wastewater, and general
              industrial applications
            </p>
            <p className="ml-4">
              <u>Lug</u>: Offers easy installation and removal in piping systems
            </p>
            <p className="ml-4">
              <u>Flanged</u>: Provides a secure connection and is often used in
          ...
          <div>
            ...
            <p className="ml-4">
              <u>High-performance applications</u>: Commonly used in water
              distribution, wastewater, and HVAC systems
            </p>
          </div>
          <div>
            <p className="font-semibold text-orange-600">
            ...
            <p className="ml-4">
              <u>High-performance</u>: Ideal for applications requiring zero
              leakage and high durability, such as in petrochemical, oil and gas
              industries
            </p>
          </div>
        </div>
