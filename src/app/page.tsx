...
const productCategories = [
  { name: "Butterfly Valve", image: "/butterfly_valve.jpg", description: "Ideal for on-off and throttling services." },
  { name: "Ball Valve", image: "/ball_valve.jpg", description: "Excellent for high pressure and temperature applications." },
  { name: "Gate Valve", image: "/gate_valve.jpg", description: "Perfect for fully open or fully closed service." },
  { name: "Globe Valve", image: "/globe_valve.jpg", description: "Designed for regulating flow in a pipeline." },
  { name: "Check Valve", image: "/check_valve.jpg", description: "Prevents backflow in piping systems." },
  { name: "Plug Valve", image: "/plug_valve.jpg", description: "Suitable for slurry, viscous, and general applications." },
];
    ...
    <div className="font-sans">
      ...
      <main className="py-8 px-6 md:px-12 lg:px-24">
        ...
        <section className="mb-16">
          ...
          <HoverEffect items={productCategories.map((category) => ({
            title: category.name,
        ...
        <section className="mb-16">
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2">
              <p className="text-lg mb-4">At Tangent Valves, we are committed to delivering top-notch industrial valves and exceptional service to our clients worldwide. Our team of experienced professionals works tirelessly to ensure that our products meet the highest standards of quality and performance.</p>
              <p className="text-lg mb-4">With years of industry expertise and a passion for innovation, Tangent Valves is your trusted partner for all your industrial valve needs.</p>
            </div>
          </div>
        </section>
      ...
      <footer className="bg-gray-100 py-8 px-6 md:px-12 lg:px-24">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 mb-4 md:mb-0">© {new Date().getFullYear()} Tangent Valves. All rights reserved.</p>
